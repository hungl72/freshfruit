					...
					<c:forEach items="${listNewsDetail}" var="nd">
						<div class="col-lg-4 col-md-6">
							<div class="single-latest-news">
								<a href="${pageContext.request.contextPath}/news/detail/${nd.news_id}/${nd.news_detail_id}"><img src="${urlUpload}/${nd.news_detail_image}" alt="" height="200px;" width="400px;"></a>
								<div class="news-text-box">
									...
									<p class="excerpt">${fn:substring(nd.news_detail_description, 0, 300)}</p>
