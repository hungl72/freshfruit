						...
						<div class="col-lg-4 col-md-6 text-center strawberry">
							<div class="single-product-item">
								<div class="product-image">
									<a href="${pageContext.request.contextPath}/product/${product.menu_id}/${product.product_id}"><img src="${pageContext.request.contextPath}/${urlUpload}/${product.product_image}" alt=""></a>
								</div>
					...
					<c:forEach items="${resultDetail}" var="l">
						<div class="col-lg-4 col-md-6">
							<div class="single-latest-news">
								<a href="${pageContext.request.contextPath}/news/detail/${l.news_id}/${l.news_detail_id}"><img src="${pageContext.request.contextPath}/${urlUpload}/${l.news_detail_image}" alt=""></a>
